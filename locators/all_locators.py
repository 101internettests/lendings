...
class Profit:
    ...
    BUTTON_CHANGE_CITY = "xpath=(//button[contains(@class,'profit_address_button_change_city')])[1]"
...
class Connection:
    ...
    BUTTON_CHANGE_CITY = "xpath=//button[contains(@class,'connection_address_button_change_city')]"
