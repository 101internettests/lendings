...
class TestRTKImternetOnlineSecond:
    ...
    def test_check_website_without_certificate(self, page_fixture, rtk_internet_online_second):
    ...
    def test_application_popup_super_offer(self, page_fixture, rtk_internet_online_second):
        page = page_fixture
        page.goto(rtk_internet_online_second)
    ...
    def test_application_popup_super_offer_red_button(self, page_fixture, rtk_internet_online_second):
        page = page_fixture
        page.goto(rtk_internet_online_second)
        mts_page = MtsHomeOnlinePage(page=page)
        internet_page = MtsInternetHomeOnlinePage(page=page)
    ...
    def test_application_popup_button_connect(self, page_fixture, rtk_internet_online_second):
        page = page_fixture
        page.goto(rtk_internet_online_second)
        mts_page = MtsHomeOnlinePage(page=page)
        rostelecom_page = RostelecomPage(page=page)
    ...
    def test_application_popup_button_application_two(self, page_fixture, rtk_internet_online_second):
        page = page_fixture
        page.goto(rtk_internet_online_second)
        mts_page = MtsHomeOnlinePage(page=page)
        rostelecom_page = RostelecomPage(page=page)
    ...
    def test_application_from_tariff_cards(self, page_fixture, rtk_internet_online_second):
        page = page_fixture
        page.goto(rtk_internet_online_second)
        mts_page = MtsHomeOnlinePage(page=page)
        rostelecom_page = RostelecomPage(page=page)
    ...
    def test_application_popup_button_connect_traid(self, page_fixture, rtk_internet_online_second):
        page = page_fixture
        page.goto(rtk_internet_online_second)
        mts_page = MtsHomeOnlinePage(page=page)
        rostelecom_page = RostelecomPage(page=page)
    ...
    def test_application_popup_leave_connection(self, page_fixture, rtk_internet_online_second):
        page = page_fixture
        page.goto(rtk_internet_online_second)
        mts_page = MtsHomeOnlinePage(page=page)
        rostelecom_page = RostelecomPage(page=page)
    ...
    @allure.title("9. Узнайте все акции и тарифы от Ростелеком в вашем доме")
    def test_application_popup_know_all_sales(self, page_fixture, rtk_internet_online_second):
        page = page_fixture
        page.goto(rtk_internet_online_second)
        mts_page = MtsHomeOnlinePage(page=page)
        rostelecom_page = RostelecomPage(page=page)
    ...
    def test_application_popup_button_connect_futer(self, page_fixture, rtk_internet_online_second):
        page = page_fixture
        page.goto(rtk_internet_online_second)
        mts_page = MtsHomeOnlinePage(page=page)
        rostelecom_page = RostelecomPage(page=page)
