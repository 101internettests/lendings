...
class TestRTKOHomeInternetRu:
    ...
    def test_application_popup_super_offer_third(self, page_fixture, rtk_home_internet_ru):
        page = page_fixture
    ...
    def test_check_all_city_links(self, page_fixture, rtk_home_internet_ru):
        page = page_fixture
        page.goto(rtk_home_internet_ru)
        rostelecom_page = RostelecomPage(page=page)
        time.sleep(15)
