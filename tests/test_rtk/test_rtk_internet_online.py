...
@allure.feature("https://rt-internet.online/")
class TestRTKOInternetOnline:
    @allure.title("1.1. Проверка работы сайта при отсутствии сертификата")
    def test_check_website_without_certificate(self, page_fixture, rtk_internet_online_ru):
    ...
    def test_application_popup_super_offer(self, page_fixture, rtk_internet_online_ru):
        page = page_fixture
        page.goto(rtk_internet_online_ru)
    ...
    def test_application_popup_super_offer_red_button(self, page_fixture, rtk_internet_online_ru):
        page = page_fixture
        page.goto(rtk_internet_online_ru)
        mts_page = MtsHomeOnlinePage(page=page)
        internet_page = MtsInternetHomeOnlinePage(page=page)
    ...
    def test_application_popup_button_connect(self, page_fixture, rtk_internet_online_ru):
        page = page_fixture
        page.goto(rtk_internet_online_ru)
        mts_page = MtsHomeOnlinePage(page=page)
        rostelecom_page = RostelecomPage(page=page)
    ...
    def test_application_popup_button_application_two(self, page_fixture, rtk_internet_online_ru):
        page = page_fixture
        page.goto(rtk_internet_online_ru)
        mts_page = MtsHomeOnlinePage(page=page)
        rostelecom_page = RostelecomPage(page=page)
    ...
    def test_application_popup_all_forms(self, page_fixture, rtk_internet_online_ru):
        page = page_fixture
        page.goto(rtk_internet_online_ru)
        mts_page = MtsHomeOnlinePage(page=page)
        rostelecom_page = RostelecomPage(page=page)
    ...
    def test_application_from_tariff_cards(self, page_fixture, rtk_internet_online_ru):
        page = page_fixture
        page.goto(rtk_internet_online_ru)
        mts_page = MtsHomeOnlinePage(page=page)
        rostelecom_page = RostelecomPage(page=page)
    ...
    def test_application_popup_button_connect_futer(self, page_fixture, rtk_internet_online_ru):
        page = page_fixture
        page.goto(rtk_internet_online_ru)
        mts_page = MtsHomeOnlinePage(page=page)
        rostelecom_page = RostelecomPage(page=page)
    ...
    def test_check_all_pages(self, page_fixture, rtk_internet_online_ru):
        page = page_fixture
        page.goto(rtk_internet_online_ru)
        rostelecom_page = RostelecomPage(page=page)
        rostelecom_page.check_all_links_rtk()

    @allure.title("10. Выбор региона Абакан из хедера")
    def test_choose_region_header(self, page_fixture, rtk_internet_online_ru):
        page = page_fixture
        page.goto(rtk_internet_online_ru)
        mts_page = MtsHomeOnlinePage(page=page)
