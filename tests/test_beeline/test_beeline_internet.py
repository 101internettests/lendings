...
@allure.feature("https://beelline-internet.ru/")
class TestBeelineInternetRu:
    @allure.title("1. Выбор региона из всплывающего попапа Уточните ваш город")
    def test_choose_region_from_popup(self, page_fixture, beeline_internet):
        page = page_fixture
    ...
    def test_check_website_without_certificate(self, page_fixture, beeline_internet):
    ...
    def test_application_popup_super_offer_yellow_button(self, page_fixture, beeline_internet):
        page = page_fixture
        page.goto(beeline_internet)
        mts_page = MtsHomeOnlinePage(page=page)
        domru_page = DomRuClass(page=page)
    ...
    def test_application_popup_button_connect(self, page_fixture, beeline_internet):
        page = page_fixture
        page.goto(beeline_internet)
        mts_page = MtsHomeOnlinePage(page=page)
        domru_page = DomRuClass(page=page)
    ...
    def test_a_lot_of_forms_beeline(self, page_fixture, beeline_internet):
        page = page_fixture
        page.goto(beeline_internet)
        mts_page = MtsHomeOnlinePage(page=page)
        domru_page = DomRuClass(page=page)
    ...
    def test_application_from_tariff_cards(self, page_fixture, beeline_internet):
        page = page_fixture
        page.goto(beeline_internet)
        mts_page = MtsHomeOnlinePage(page=page)
        domru_page = DomRuClass(page=page)
    ...
    def test_popup_get_consultation(self, page_fixture, beeline_internet):
        page = page_fixture
        page.goto(beeline_internet)
        mts_page = MtsHomeOnlinePage(page=page)
        domru_page = DomRuClass(page=page)
    ...
    def test_application_popup_button_connect_futer(self, page_fixture, beeline_internet):
        page = page_fixture
        page.goto(beeline_internet)
        mts_page = MtsHomeOnlinePage(page=page)
        domru_page = DomRuClass(page=page)
    ...
    def test_check_all_pages(self, page_fixture, beeline_internet):
        page = page_fixture
        page.goto(beeline_internet)
        domru_page = DomRuClass(page=page)
        time.sleep(5)
    ...
    # def test_check_dont_find_city(self, page_fixture, beeline_internet):
    #     page = page_fixture
    #     page.goto(beeline_internet)
    #     domru_page = DomRuClass(page=page)
    #     domru_page.close_popup_location()
